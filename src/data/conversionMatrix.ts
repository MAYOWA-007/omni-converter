...
export const CONVERSION_RECIPES: ConversionRecipe[] = [
  ...
  recipe({
    ...
    output: "Image ZIP",
    title: "Extract presentation images",
    description: "Extract embedded PowerPoint raster and vector images into a focused ZIP with an optional source manifest.",
    treatments: ["PNG", "JPEG", "SVG", "WebP", "ZIP"],
    keywords: ["pptx", "powerpoint", "extract", "images", "pictures", "graphics", "photos", "zip"],
    editorControls: ["metadata", "batchNaming", "bundle"],
    controlOptions: { metadata: ["Include manifest", "Assets only"], batchNaming: ["Images suffix", "Clean filename"], bundle: ["Store ZIP", "Balanced ZIP", "Maximum ZIP"] },
    requiredCapabilities: ["zip", "worker"],
    intensity: "standard",
  ...
  recipe({
    ...
    category: "Audio extraction",
    output: "Audio ZIP",
    title: "Extract presentation audio",
    description: "Extract embedded narration, music, and other audio files from a PowerPoint package.",
    treatments: ["MP3", "WAV", "M4A", "AAC", "ZIP"],
    keywords: ["pptx", "powerpoint", "extract", "audio", "narration", "music", "voiceover", "zip"],
    editorControls: ["metadata", "batchNaming", "bundle"],
    controlOptions: { metadata: ["Include manifest", "Assets only"], batchNaming: ["Audio suffix", "Clean filename"], bundle: ["Store ZIP", "Balanced ZIP", "Maximum ZIP"] },
    requiredCapabilities: ["zip", "worker"],
    intensity: "standard",
    engine: "Bounded zip.js Office package reader"
  }),
  recipe({
    ...
    input: ["presentation"],
    inputFormats: ["pptx"],
    category: "Video extraction",
    output: "Video ZIP",
    title: "Extract presentation video",
    description: "Extract embedded video clips from a PowerPoint package without transcoding their original bytes.",
    treatments: ["MP4", "MOV", "WebM", "Original bytes", "ZIP"],
    keywords: ["pptx", "powerpoint", "extract", "video", "movie", "clip", "mp4", "zip"],
    editorControls: ["metadata", "batchNaming", "bundle"],
    controlOptions: { metadata: ["Include manifest", "Assets only"], batchNaming: ["Video suffix", "Clean filename"], bundle: ["Store ZIP", "Balanced ZIP", "Maximum ZIP"] },
    requiredCapabilities: ["zip", "worker"],
    intensity: "standard",
    engine: "Bounded zip.js Office package reader"
  }),
  recipe({
    ...
    category: "Asset extraction",
    output: "Media ZIP",
    title: "Extract all presentation media",
    description: "Extract every embedded PowerPoint image, audio file, and video clip with an optional source manifest.",
